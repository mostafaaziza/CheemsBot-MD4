...
break
case 'alive': case 'القايمه': case 'اوامر': case 'menu': case 'القائمه': case 'المميزات': {
		if (isBan) return reply(mess.ban)	 			
if (isBanChat) return reply(mess.banChat)
...
await XeonBotInc.send5ButImg(from, `مرحبا بك في ⤌ قائمه المالك ⋆ 	
⋆  ${prefix}خاص
⋆  ${prefix}عام
⋆  ${prefix}وهمي
⋆  ${prefix}بان [on/off]
...
🖤   ̶ ̶  ̶❁ ̶ ̶ ̶a̶l̶̶a̶z̶i̶z̶y̶ ̶  ̶❁ ̶ ̶  ̶ ̶ ̶ 🖤` + '' + ' ', `${botname}`,unicorn, [{"quickReplyButton": {"displayText": "⋆ المبرمج •","id": 'owner'}}] )
break
case 'groupmenu':
case 'اوامر الجروب':
	   if (isBan) return reply(mess.ban)
...
await XeonBotInc.send5ButImg(from, `مرحبا بك في ⤌ قائمه الجروب ⋆ 	
⋆ ${prefix}اعدادات
⋆ ${prefix}لينك
...
await XeonBotInc.send5ButImg(from, `مرحبا بك في ⤌ RPGقائمه ⋆ 	
⋆ ${prefix}hunt
⋆ ${prefix}mine
⋆ ${prefix}fish
⋆ ${prefix}heal
...
await XeonBotInc.send5ButImg(from, `مرحبا بك في ⤌ قائمه عمل لوجو ⋆ 	
⋆ ${prefix}candy
⋆ ${prefix}8bit
⋆ ${prefix}horror
⋆ ${prefix}hoorror
...
await XeonBotInc.send5ButImg(from, `مرحبا بك في ⤌ قائمه التنزيل ⋆ 	
...
await XeonBotInc.send5ButImg(from, `مرحبا بك في ⤌ قائمه البحث ⋆ 	
⋆ ${prefix}شغل [query]
⋆ ${prefix}تشغيل [query]
⋆ ${prefix}yts [query]
⋆ ${prefix}lyrics [query]
...
await XeonBotInc.send5ButImg(from, `مرحبا بك في ⤌ قائمه التحويل ⋆ 	
...
await XeonBotInc.send5ButImg(from, `مرحبا بك في ⤌ قائمه صور عشوائيه ⋆ 	
⋆ ${prefix}coffee
⋆ ${prefix}bts
⋆ ${prefix}woof
⋆ ${prefix}meow
...
await XeonBotInc.send5ButImg(from, `مرحبا بك في ⤌ قائمه تحويل ايموجي ⋆ 	
...
await XeonBotInc.send5ButImg(from, `مرحبا بك في ⤌ قائمه انمي ⋆ 	
⋆ ${prefix}ناروتو
⋆ ${prefix}yaoi
⋆ ${prefix}neko2
⋆ ${prefix}waifu
...
await XeonBotInc.send5ButImg(from, `مرحبا بك في ⤌ قائمه استيكرات ⋆ 	
⋆  ${prefix}patrick
⋆  ${prefix}emoji
⋆  ${prefix}emojimix
⋆  ${prefix}attp
...
await XeonBotInc.send5ButImg(from, `مرحبا بك في ⤌ قائمه استيكر انمي ⋆ 	
⋆ ${prefix}لولي
⋆ ${prefix}bully
⋆ ${prefix}cuddle
⋆ ${prefix}cry
...
await XeonBotInc.send5ButImg(from, `مرحبا بك في ⤌ قائمه انمي اباحي ⋆ 	
⋆ ${prefix}hentaivideo
⋆ ${prefix}yuri
⋆ ${prefix}masturbation
⋆ ${prefix}thighs
...
await XeonBotInc.send5ButImg(from, `مرحبا بك في ⤌ قائمه التسليه ⋆ 	
⋆  ${prefix}زواج
⋆  ${prefix}زوجني
⋆  ${prefix}احمق
⋆  ${prefix}بشع
...
await XeonBotInc.send5ButImg(from, `مرحبا بك في ⤌ قائمه صوتيات ⋆ 	
⋆  ${prefix}sound1
⋆  ${prefix}sound2
⋆  ${prefix}sound3
⋆  ${prefix}sound4
...
await XeonBotInc.send5ButImg(from, `مرحبا بك في ⤌ قائمه الالعاب ⋆ 	
⋆  ${prefix}truth
⋆  ${prefix}dare
⋆  ${prefix}tictactoe
⋆  ${prefix}delttt
...
await XeonBotInc.send5ButImg(from, `مرحبا بك في ⤌ قائمه القرآن ⋆ 	
...
await XeonBotInc.send5ButImg(from, `مرحبا بك في ⤌ قائمه هنديه ⋆ 	
⋆  ${prefix}darkjoke
⋆  ${prefix}quotes
⋆  ${prefix}animequotes
